<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="basicsuccesspage.aspx.cs" Inherits="Primary_Healthcare.basicsuccesspage" %>
...
<span class="date">
    ...
    <br />
        ...
        <asp:Label ID="tempo" runat="server" Visible="False"></asp:Label>
    <br />
    <br />
