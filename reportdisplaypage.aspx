<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportdisplaypage.aspx.cs" Inherits="Primary_Healthcare.WebForm1" %>
...
<body>
    ...
    <center>
        <asp:Panel ID="Panel1" runat="server" BackColor="White" Width="880px" 
            ...
            <br />
            <br />
            <asp:Table ID="Table1" runat="server" align="Left" CellPadding="2" 
                CellSpacing="2">
